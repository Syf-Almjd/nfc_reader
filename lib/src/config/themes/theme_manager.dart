...
ThemeData getApplicationTheme() {
  return ThemeData.light(
    useMaterial3: true
      ...
      ).copyWith(primary: AppColors.primaryColor, surfaceTint: AppColors.primaryLight.withOpacity(0.5)),
      ...
      ///THIS CODE IS FOR FURTHER THEME CUSTOMIZATION
      // // ripple color
...
ThemeData getDarkApplicationTheme() {
  return getApplicationTheme(); //Temp until decided
